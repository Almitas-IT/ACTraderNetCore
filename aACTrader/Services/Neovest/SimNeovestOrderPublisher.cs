...
namespace aACTrader.Services.Neovest
{
    public class SimNeovestOrderPublisher
    {
        private readonly ILogger<SimNeovestOrderPublisher> _logger;
        private IConfiguration _configuration { get; set; }

        private const string QUEUENAME = "NeovestOrderQueueSim";

        private IModel _model { get; set; }
        private IConnection _connection { get; set; }

        public SimNeovestOrderPublisher(ILogger<SimNeovestOrderPublisher> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        {
            _logger.LogInformation("Creating connection to RabbitMQ broker..." + QUEUENAME);
