...
{
    public class NeovestOrderPublisher
    {
        private readonly ILogger<NeovestOrderPublisher> _logger;
        private IConfiguration _configuration { get; set; }

        private const string QUEUENAME = "NeovestOrderQueue";

        private IModel _model { get; set; }
        private IConnection _connection { get; set; }

        public NeovestOrderPublisher(ILogger<NeovestOrderPublisher> logger, IConfiguration configuration)
        {
            _logger = logger;
