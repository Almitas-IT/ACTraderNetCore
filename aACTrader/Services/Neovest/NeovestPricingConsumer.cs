...
{
    public class NeovestPricingConsumer
    {
        private readonly ILogger<NeovestPricingConsumer> _logger;
        ...
        private const string QUEUENAME = "NeovestPriceQueue";

        public NeovestPricingConsumer(ILogger<NeovestPricingConsumer> logger, CachingService cache, IConfiguration configuration)
        {
            _logger = logger;
            _cache = cache;
        ...
        public void ProcessMessage(object sender, BasicDeliverEventArgs e)
        {
            ...
            {
                _logger.LogInformation("Consumed " + _consumedMessages + " Neovest batch messages...");
                _consumedMessages = 0;
            }
        }
        ...
        private void PopulateBatchMonitor()
        {
            try
            {
                ...
                dict["Neovest Delayed Prices"].LastUpdate = DateTime.Now;
            }
            catch (Exception)
            {
            }
