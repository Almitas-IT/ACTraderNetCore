...
{
    public class BBGJobUpdatePublisher
    {
        private readonly ILogger<BBGJobUpdatePublisher> _logger;
        private IConfiguration _configuration { get; set; }

        private const string QUEUENAME = "BBGJobUpdateQueue";

        private IModel _model { get; set; }
        private IConnection _connection { get; set; }

        public BBGJobUpdatePublisher(ILogger<BBGJobUpdatePublisher> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        public void PublishMessage(BBGJob jobRequest)
        {
            try
            {
                ...
                String jsonified = JsonConvert.SerializeObject(jobRequest);
