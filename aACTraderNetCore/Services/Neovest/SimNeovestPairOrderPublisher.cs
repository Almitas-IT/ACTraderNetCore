...
{
    public class SimNeovestPairOrderPublisher
    {
        private readonly ILogger<SimNeovestPairOrderPublisher> _logger;
        private IConfiguration _configuration { get; set; }

        private const string QUEUENAME = "NeovestPairOrderQueueSim";

        private IModel _model { get; set; }
        private IConnection _connection { get; set; }

        public SimNeovestPairOrderPublisher(ILogger<SimNeovestPairOrderPublisher> logger, IConfiguration configuration)
        {
            _logger = logger;
        ...
        public void PublishMessage(NewPairOrder order)
        {
            try
            {
