...
{
    public class NeovestPairOrderPublisher
    {
        private readonly ILogger<NeovestPairOrderPublisher> _logger;
        private IConfiguration _configuration { get; set; }

        private const string QUEUENAME = "NeovestPairOrderQueue";

        private IModel _model { get; set; }
        private IConnection _connection { get; set; }

        public NeovestPairOrderPublisher(ILogger<NeovestPairOrderPublisher> logger, IConfiguration configuration)
        {
            _logger = logger;
