...
namespace aACTrader.Services.EMSX.Simulation
{
    public class SimEMSXOrderPublisher
    {
        private readonly ILogger<SimEMSXOrderPublisher> _logger;
        private IConfiguration _configuration { get; set; }

        private const string QUEUENAME = "EMSXOrderQueueSim";

        private IModel _model { get; set; }
        private IConnection _connection { get; set; }

        public SimEMSXOrderPublisher(ILogger<SimEMSXOrderPublisher> logger, IConfiguration configuration)
        {
            _logger = logger;
